function GRLM10Smooth = GRLM10Smooth_importfile2(filename)%, startRow, endRow)
% if nargin<=2
    startRow = 1;
    endRow = inf;
% end
...
GRLM10Smooth = cell2mat(raw);
% 
I=find((GRLM10Smooth(:,1)>19800000)&(GRLM10Smooth(:,1)<99800000)); 
GRLM10Smooth=GRLM10Smooth(I,[1,4]); 
